...
function sendMail(memberInfo) {
	...
	for(i=0; i<toSendList.length; i++) {
		...
		clientData += "&projectMembers[" + i + "].pmbLevel=" + toSendList[i][2];
		clientData += "&projectMembers[" + i + "].pmbClass=" + toSendList[i][3];
		clientData += "&projectMembers[" + i + "].pmbEmail=" + toSendList[i][4];
	}
...
function createMiddle(memberList) {
	...
	for(i=0; i<memberList.length; i++) {
		table += "<tr class='middle' onClick='sendRight(\"" + memberList[i].pmbCode + ":" + memberList[i].pmbName + ":" + memberList[i].pmbLevelName + ":" + memberList[i].pmbClassName + ":" + memberList[i].pmbEmail + "\")'><td value='" + memberList[i].pmbCode + "'>" + memberList[i].pmbCode + "</td>"
				+ "<td value='" + memberList[i].pmbName + "'>" + memberList[i].pmbName + "</td>"
				+ "<td value='" + memberList[i].pmbLevelName + "'>" + memberList[i].pmbLevelName + "</td>"
				+ "<td value='" + memberList[i].pmbClassName + "'>" + memberList[i].pmbClassName + "</td>"
				+ "<td value='" + memberList[i].pmbEmail + "'>" + memberList[i].pmbEmail + "</td></tr>"
	}
	table += "</table>";
